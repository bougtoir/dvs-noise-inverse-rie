...
- manuscript_ieee_sensors.pdf (if LibreOffice is available)
...
def main():
    ...
    # 4. Optional PDF conversion for page-count verification
    if shutil.which('libreoffice'):
        run('libreoffice --headless --convert-to pdf manuscript_ieee_sensors.docx')
        pdf_path = SCRIPT_DIR / 'manuscript_ieee_sensors.pdf'
        if pdf_path.exists():
